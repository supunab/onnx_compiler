...
using f71a01a7ef2c6ee3b4bd247b4405aa399719be5fe = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;
...
void bmm_rcr_454 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 64 && N == 64 && K == 160) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f71a01a7ef2c6ee3b4bd247b4405aa399719be5fe::ElementAccumulator;

    typename f71a01a7ef2c6ee3b4bd247b4405aa399719be5fe::Arguments arguments{
    ...
    f71a01a7ef2c6ee3b4bd247b4405aa399719be5fe gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rcr_454 specialization."
  );
}