...
using feba6d147660ca71d9a2206c98c7d3204c343bbb1 = cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tt_align8_base;

void bmm_rrr_permute_175 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 1024 && N == 80 && K == 1024) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename feba6d147660ca71d9a2206c98c7d3204c343bbb1::ElementAccumulator;

    typename feba6d147660ca71d9a2206c98c7d3204c343bbb1::Arguments arguments{
    ...
    feba6d147660ca71d9a2206c98c7d3204c343bbb1 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rrr_permute_175 specialization."
  );
}