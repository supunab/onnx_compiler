...
#define CUTLASS_CHECK(status)                                                         \
  ...
  using Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8 = 
...
using f835f6b8ccf55e578e3fc9219544b49ae63040319 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;

void gemm_rcr_bias_mul_339 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 512 && N == 5120 && K == 1280) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f835f6b8ccf55e578e3fc9219544b49ae63040319::ElementAccumulator;

    typename f835f6b8ccf55e578e3fc9219544b49ae63040319::Arguments arguments{
    ...
    f835f6b8ccf55e578e3fc9219544b49ae63040319 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_mul_339 specialization."
  );
}