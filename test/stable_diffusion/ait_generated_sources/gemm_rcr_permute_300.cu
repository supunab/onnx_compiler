...
#define CUTLASS_CHECK(status)                                                         \
  {                                                                                   \
    ...
    cutlass::gemm::device::GemmUniversal<
        ...
        false,  /*GatherB*/
        false,  /*ScatterD*/
        cutlass::layout::Tensor5DPermute20314<256, 1, 8> /*PermuteDLayout*/
    >;
      
using fb4b14f24fe6c12a26fd064328c9beed676e70f3d = cutlass_tensorop_f16_s16816gemm_f16_128x256_32x3_tn_align8_base;

void gemm_rcr_permute_300 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 512 && N == 1280 && K == 1280) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fb4b14f24fe6c12a26fd064328c9beed676e70f3d::ElementAccumulator;

    typename fb4b14f24fe6c12a26fd064328c9beed676e70f3d::Arguments arguments{
    ...
    fb4b14f24fe6c12a26fd064328c9beed676e70f3d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_permute_300 specialization."
  );
}