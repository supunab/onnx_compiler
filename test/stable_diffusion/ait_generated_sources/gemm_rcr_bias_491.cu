...
using f2ff024a8e5fb01f0d25047c5b90c0b050fc3d943 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x128_32x6_tn_align8;

void gemm_rcr_bias_491 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 128 && N == 1280 && K == 5120) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f2ff024a8e5fb01f0d25047c5b90c0b050fc3d943::ElementAccumulator;

    typename f2ff024a8e5fb01f0d25047c5b90c0b050fc3d943::Arguments arguments{
    ...
    f2ff024a8e5fb01f0d25047c5b90c0b050fc3d943 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_491 specialization."
  );
}