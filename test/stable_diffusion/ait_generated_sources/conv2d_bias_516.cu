...
using f54fbf9247c314e8ccc4d37b8a07703cb1a218689 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_64x128_32x6_nhwc_align8_base>;



void conv2d_bias_516 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 8 && WI == 8 && CI == 2560) {
    
    using ElementComputeEpilogue = typename f54fbf9247c314e8ccc4d37b8a07703cb1a218689::ElementCompute;
//  TODO: cast to right dtype
    typename f54fbf9247c314e8ccc4d37b8a07703cb1a218689::Arguments arguments{
        problem_size,
    ...
    f54fbf9247c314e8ccc4d37b8a07703cb1a218689 implicit_gemm_op;
