...
using fa7a6cf03609af45524895bc0fd69aed1b873e141 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_256x128_32x3_nhwc_align8_base>;



void conv2d_bias_818 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 32 && WI == 32 && CI == 1280) {
    
    using ElementComputeEpilogue = typename fa7a6cf03609af45524895bc0fd69aed1b873e141::ElementCompute;
//  TODO: cast to right dtype
    typename fa7a6cf03609af45524895bc0fd69aed1b873e141::Arguments arguments{
        problem_size,
    ...
    fa7a6cf03609af45524895bc0fd69aed1b873e141 implicit_gemm_op;
