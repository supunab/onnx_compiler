...
using f72ef49fab2b9f56d5d0c86896e270108863d5e73 = cutlass_tensorop_f16_s16816gemm_f16_128x64_64x3_tn_align8_base;

void gemm_rcr_permute_322 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 128 && N == 1280 && K == 768) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f72ef49fab2b9f56d5d0c86896e270108863d5e73::ElementAccumulator;

    typename f72ef49fab2b9f56d5d0c86896e270108863d5e73::Arguments arguments{
    ...
    f72ef49fab2b9f56d5d0c86896e270108863d5e73 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_permute_322 specialization."
  );
}