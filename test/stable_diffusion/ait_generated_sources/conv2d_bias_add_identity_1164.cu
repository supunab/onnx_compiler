...
using fb9b0e426fe636867e40bb2a7ce725e6f82d45f9d = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x128_32x3_nhwc_align8_base>;



void conv2d_bias_add_identity_1164 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 32 && WI == 32 && CI == 640) {
    
    using ElementComputeEpilogue = typename fb9b0e426fe636867e40bb2a7ce725e6f82d45f9d::ElementCompute;
//  TODO: cast to right dtype
    typename fb9b0e426fe636867e40bb2a7ce725e6f82d45f9d::Arguments arguments{
        problem_size,
    ...
    fb9b0e426fe636867e40bb2a7ce725e6f82d45f9d implicit_gemm_op;
