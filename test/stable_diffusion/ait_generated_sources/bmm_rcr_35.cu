...
using f81e5686730e79eaf278daa21f02ffdda3530d61c = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;
...
void bmm_rcr_35 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 4096 && N == 4096 && K == 40) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f81e5686730e79eaf278daa21f02ffdda3530d61c::ElementAccumulator;

    typename f81e5686730e79eaf278daa21f02ffdda3530d61c::Arguments arguments{
    ...
    f81e5686730e79eaf278daa21f02ffdda3530d61c gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rcr_35 specialization."
  );
}