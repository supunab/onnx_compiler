...
using f3a89f6357a85a72d26791b8dbda844c2e3fd94d1 = Operation_cutlass_tensorop_f16_s16816gemm_f16_256x128_32x3_tn_align8;

void gemm_rcr_bias_340 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 512 && N == 1280 && K == 5120) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f3a89f6357a85a72d26791b8dbda844c2e3fd94d1::ElementAccumulator;

    typename f3a89f6357a85a72d26791b8dbda844c2e3fd94d1::Arguments arguments{
    ...
    f3a89f6357a85a72d26791b8dbda844c2e3fd94d1 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_340 specialization."
  );
}