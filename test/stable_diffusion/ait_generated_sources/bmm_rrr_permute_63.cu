...
using f6a15cae182c6ba7c9093cefa2441c4a10e1ddf5f = cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tt_align8_base;

void bmm_rrr_permute_63 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 4096 && N == 40 && K == 64) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f6a15cae182c6ba7c9093cefa2441c4a10e1ddf5f::ElementAccumulator;

    typename f6a15cae182c6ba7c9093cefa2441c4a10e1ddf5f::Arguments arguments{
    ...
    f6a15cae182c6ba7c9093cefa2441c4a10e1ddf5f gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rrr_permute_63 specialization."
  );
}