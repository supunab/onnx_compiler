...
using f9bab5a30db86ba2cb81d6da6cb2f5424d7a15b77 = cutlass_tensorop_f16_s16816gemm_f16_256x64_32x3_tt_align8_base;

void bmm_rrr_permute_41 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 4096 && N == 40 && K == 4096) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f9bab5a30db86ba2cb81d6da6cb2f5424d7a15b77::ElementAccumulator;

    typename f9bab5a30db86ba2cb81d6da6cb2f5424d7a15b77::Arguments arguments{
    ...
    f9bab5a30db86ba2cb81d6da6cb2f5424d7a15b77 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rrr_permute_41 specialization."
  );
}