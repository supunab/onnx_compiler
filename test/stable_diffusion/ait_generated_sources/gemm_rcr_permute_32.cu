...
#define CUTLASS_CHECK(status)                                                         \
  {                                                                                   \
    ...
    cutlass::gemm::device::GemmUniversal<
        ...
        false,  /*GatherB*/
        false,  /*ScatterD*/
        cutlass::layout::Tensor5DPermute20314<4096, 1, 8> /*PermuteDLayout*/
    >;
      
using f69234230250b36429ad9fc5ae1b47d884d58e73d = cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8_base;

void gemm_rcr_permute_32 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 8192 && N == 320 && K == 320) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f69234230250b36429ad9fc5ae1b47d884d58e73d::ElementAccumulator;

    typename f69234230250b36429ad9fc5ae1b47d884d58e73d::Arguments arguments{
    ...
    f69234230250b36429ad9fc5ae1b47d884d58e73d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_permute_32 specialization."
  );
}