...
using fc334fddcbc79ece4f9bacbff13cd77dd37b3dce9 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x64_32x6_tn_align8;
...
void bmm_rcr_191 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 1024 && N == 64 && K == 80) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fc334fddcbc79ece4f9bacbff13cd77dd37b3dce9::ElementAccumulator;

    typename fc334fddcbc79ece4f9bacbff13cd77dd37b3dce9::Arguments arguments{
    ...
    fc334fddcbc79ece4f9bacbff13cd77dd37b3dce9 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rcr_191 specialization."
  );
}