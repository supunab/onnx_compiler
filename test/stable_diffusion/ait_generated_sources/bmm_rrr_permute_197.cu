...
using f14d909783a0d1c81dcdebac7319d9f01f18f1085 = cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tt_align8_base;

void bmm_rrr_permute_197 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 1024 && N == 80 && K == 64) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f14d909783a0d1c81dcdebac7319d9f01f18f1085::ElementAccumulator;

    typename f14d909783a0d1c81dcdebac7319d9f01f18f1085::Arguments arguments{
    ...
    f14d909783a0d1c81dcdebac7319d9f01f18f1085 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rrr_permute_197 specialization."
  );
}