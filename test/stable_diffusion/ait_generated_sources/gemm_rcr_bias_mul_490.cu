...
using fa27463933602be40d580f98e8a04fd2e4ba931c2 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;

void gemm_rcr_bias_mul_490 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 128 && N == 5120 && K == 1280) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fa27463933602be40d580f98e8a04fd2e4ba931c2::ElementAccumulator;

    typename fa27463933602be40d580f98e8a04fd2e4ba931c2::Arguments arguments{
    ...
    fa27463933602be40d580f98e8a04fd2e4ba931c2 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_mul_490 specialization."
  );
}