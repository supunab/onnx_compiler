...
using f27e98d004753428a19f2063d130471776c631d0d = cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tt_align8_base;

void bmm_rrr_permute_460 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 64 && N == 160 && K == 64) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f27e98d004753428a19f2063d130471776c631d0d::ElementAccumulator;

    typename f27e98d004753428a19f2063d130471776c631d0d::Arguments arguments{
    ...
    f27e98d004753428a19f2063d130471776c631d0d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rrr_permute_460 specialization."
  );
}