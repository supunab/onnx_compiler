...
using f8e0df6100546bb3d09d7097220cb7ffe7e52f8d7 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;
...
void bmm_rcr_169 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 1024 && N == 1024 && K == 80) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f8e0df6100546bb3d09d7097220cb7ffe7e52f8d7::ElementAccumulator;

    typename f8e0df6100546bb3d09d7097220cb7ffe7e52f8d7::Arguments arguments{
    ...
    f8e0df6100546bb3d09d7097220cb7ffe7e52f8d7 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rcr_169 specialization."
  );
}