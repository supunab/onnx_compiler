...
using f0e07e83ce391b9570231c28ad0f762da18354e89 = Operation_cutlass_tensorop_f16_s16816gemm_f16_256x128_32x3_tn_align8;

void gemm_rcr_bias_206 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 2048 && N == 640 && K == 2560) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f0e07e83ce391b9570231c28ad0f762da18354e89::ElementAccumulator;

    typename f0e07e83ce391b9570231c28ad0f762da18354e89::Arguments arguments{
    ...
    f0e07e83ce391b9570231c28ad0f762da18354e89 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_206 specialization."
  );
}