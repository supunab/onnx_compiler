...
using f168cd90908e5cd28591b21a8c6c140aa3dd96e07 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x128_32x3_nhwc_align8_base>;



void conv2d_bias_add_identity_1161 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 64 && WI == 64 && CI == 320) {
    
    using ElementComputeEpilogue = typename f168cd90908e5cd28591b21a8c6c140aa3dd96e07::ElementCompute;
//  TODO: cast to right dtype
    typename f168cd90908e5cd28591b21a8c6c140aa3dd96e07::Arguments arguments{
        problem_size,
    ...
    f168cd90908e5cd28591b21a8c6c140aa3dd96e07 implicit_gemm_op;
