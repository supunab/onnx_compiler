...
using f6e688c66d1339b4f1e8f2e3b7c0b3598ea60c11c = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;
...
void gemm_rcr_bias_relu_8 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 1024 && N == 1024 && K == 784) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f6e688c66d1339b4f1e8f2e3b7c0b3598ea60c11c::ElementAccumulator;

    typename f6e688c66d1339b4f1e8f2e3b7c0b3598ea60c11c::Arguments arguments{
    ...
    f6e688c66d1339b4f1e8f2e3b7c0b3598ea60c11c gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_relu_8 specialization."
  );
}