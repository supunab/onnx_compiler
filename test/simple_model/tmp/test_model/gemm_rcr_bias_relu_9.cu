...
using fab78eee235b5e8ca27a2bf610656fecbc7024e17 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;
...
void gemm_rcr_bias_relu_9 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 1024 && N == 2048 && K == 1024) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fab78eee235b5e8ca27a2bf610656fecbc7024e17::ElementAccumulator;

    typename fab78eee235b5e8ca27a2bf610656fecbc7024e17::Arguments arguments{
    ...
    fab78eee235b5e8ca27a2bf610656fecbc7024e17 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_relu_9 specialization."
  );
}