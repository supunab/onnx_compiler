...
using fa3a0d9723b6813a056a68a5ab649ea8736363e23 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x128_32x6_tn_align8;
...
void gemm_rcr_bias_6 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 1024 && N == 10 && K == 512) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fa3a0d9723b6813a056a68a5ab649ea8736363e23::ElementAccumulator;

    typename fa3a0d9723b6813a056a68a5ab649ea8736363e23::Arguments arguments{
    ...
    fa3a0d9723b6813a056a68a5ab649ea8736363e23 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_6 specialization."
  );
}