...
using f426a1e486fb1e0c2b86b5259531fbf8aabe75f86 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x128_32x3_nhwc_align4_base>;
...
void conv2d_bias_15 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 64 && WI == 64 && CI == 4) {
    
    using ElementComputeEpilogue = typename f426a1e486fb1e0c2b86b5259531fbf8aabe75f86::ElementCompute;
//  TODO: cast to right dtype
    typename f426a1e486fb1e0c2b86b5259531fbf8aabe75f86::Arguments arguments{
        problem_size,
    ...
    f426a1e486fb1e0c2b86b5259531fbf8aabe75f86 implicit_gemm_op;
