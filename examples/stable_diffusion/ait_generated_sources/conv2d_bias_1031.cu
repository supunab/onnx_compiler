...
using fcf14e9b86885b63d31dc4e5ceef7583182f063db = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x128_32x3_nhwc_align8_base>;



void conv2d_bias_1031 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 64 && WI == 64 && CI == 640) {
    
    using ElementComputeEpilogue = typename fcf14e9b86885b63d31dc4e5ceef7583182f063db::ElementCompute;
//  TODO: cast to right dtype
    typename fcf14e9b86885b63d31dc4e5ceef7583182f063db::Arguments arguments{
        problem_size,
    ...
    fcf14e9b86885b63d31dc4e5ceef7583182f063db implicit_gemm_op;
