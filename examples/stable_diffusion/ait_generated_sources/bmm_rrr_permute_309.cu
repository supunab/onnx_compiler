...
using fb7afe14ecc1809f64adc24284ad634cad812ad8d = cutlass_tensorop_f16_s16816gemm_f16_128x64_32x6_tt_align8_base;

void bmm_rrr_permute_309 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 256 && N == 160 && K == 256) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fb7afe14ecc1809f64adc24284ad634cad812ad8d::ElementAccumulator;

    typename fb7afe14ecc1809f64adc24284ad634cad812ad8d::Arguments arguments{
    ...
    fb7afe14ecc1809f64adc24284ad634cad812ad8d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rrr_permute_309 specialization."
  );
}