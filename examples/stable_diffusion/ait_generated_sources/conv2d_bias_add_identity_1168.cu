...
using fd14bc514da6001d10d104bc88f6c8a664c7caa1b = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x256_32x3_nhwc_align8_base>;



void conv2d_bias_add_identity_1168 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 16 && WI == 16 && CI == 1280) {
    
    using ElementComputeEpilogue = typename fd14bc514da6001d10d104bc88f6c8a664c7caa1b::ElementCompute;
//  TODO: cast to right dtype
    typename fd14bc514da6001d10d104bc88f6c8a664c7caa1b::Arguments arguments{
        problem_size,
        {(cutlass::half_t*)(in_ptr), layout_A},
        {(cutlass::half_t*)(weight_ptr), layout_B},
        {(cutlass::half_t*)(res_ptr), layout_C},
    ...
    fd14bc514da6001d10d104bc88f6c8a664c7caa1b implicit_gemm_op;
