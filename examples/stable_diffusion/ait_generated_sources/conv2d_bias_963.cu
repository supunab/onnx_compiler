...
using fd264119169e4c0cabfd677ff732c9e78cf94975f = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x128_32x3_nhwc_align8_base>;



void conv2d_bias_963 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 64 && WI == 64 && CI == 960) {
    
    using ElementComputeEpilogue = typename fd264119169e4c0cabfd677ff732c9e78cf94975f::ElementCompute;
//  TODO: cast to right dtype
    typename fd264119169e4c0cabfd677ff732c9e78cf94975f::Arguments arguments{
        problem_size,
    ...
    fd264119169e4c0cabfd677ff732c9e78cf94975f implicit_gemm_op;
