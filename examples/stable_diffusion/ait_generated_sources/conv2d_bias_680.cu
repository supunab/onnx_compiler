...
using f7b047f68a9976d37dab4ecdb09b7fa7b3114860c = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x256_32x3_nhwc_align8_base>;



void conv2d_bias_680 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 16 && WI == 16 && CI == 1920) {
    
    using ElementComputeEpilogue = typename f7b047f68a9976d37dab4ecdb09b7fa7b3114860c::ElementCompute;
//  TODO: cast to right dtype
    typename f7b047f68a9976d37dab4ecdb09b7fa7b3114860c::Arguments arguments{
        problem_size,
    ...
    f7b047f68a9976d37dab4ecdb09b7fa7b3114860c implicit_gemm_op;
