...
using f51b14178e34e88dba9fa85957ff782aa47dfa037 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_64x128_64x3_nhwc_align8_base>;



void conv2d_bias_add_identity_1172 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 8 && WI == 8 && CI == 1280) {
    
    using ElementComputeEpilogue = typename f51b14178e34e88dba9fa85957ff782aa47dfa037::ElementCompute;
//  TODO: cast to right dtype
    typename f51b14178e34e88dba9fa85957ff782aa47dfa037::Arguments arguments{
        problem_size,
    ...
    f51b14178e34e88dba9fa85957ff782aa47dfa037 implicit_gemm_op;
