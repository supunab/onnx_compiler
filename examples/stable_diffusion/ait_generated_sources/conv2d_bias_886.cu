...
using f3d96043e052639d1e73973fc0ea9663be5d8a789 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_256x128_32x3_nhwc_align8_base>;



void conv2d_bias_886 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 32 && WI == 32 && CI == 960) {
    
    using ElementComputeEpilogue = typename f3d96043e052639d1e73973fc0ea9663be5d8a789::ElementCompute;
//  TODO: cast to right dtype
    typename f3d96043e052639d1e73973fc0ea9663be5d8a789::Arguments arguments{
        problem_size,
    ...
    f3d96043e052639d1e73973fc0ea9663be5d8a789 implicit_gemm_op;
