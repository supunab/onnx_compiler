...
using feb1bc599bd1a962940982789c6bb09a06038f6e0 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x256_32x3_nhwc_align8_base>;



void conv2d_bias_281 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 16 && WI == 16 && CI == 640) {
    
    using ElementComputeEpilogue = typename feb1bc599bd1a962940982789c6bb09a06038f6e0::ElementCompute;
//  TODO: cast to right dtype
    typename feb1bc599bd1a962940982789c6bb09a06038f6e0::Arguments arguments{
        problem_size,
    ...
    feb1bc599bd1a962940982789c6bb09a06038f6e0 implicit_gemm_op;
