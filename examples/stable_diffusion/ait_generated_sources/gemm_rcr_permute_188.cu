...
using f6dfe9a383c6df48a534531784b6e82a7055afe6f = cutlass_tensorop_f16_s16816gemm_f16_64x64_64x5_tn_align8_base;

void gemm_rcr_permute_188 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 128 && N == 640 && K == 768) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f6dfe9a383c6df48a534531784b6e82a7055afe6f::ElementAccumulator;

    typename f6dfe9a383c6df48a534531784b6e82a7055afe6f::Arguments arguments{
    ...
    f6dfe9a383c6df48a534531784b6e82a7055afe6f gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_permute_188 specialization."
  );
}