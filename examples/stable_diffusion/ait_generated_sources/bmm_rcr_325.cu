...
using f23472f4dfdada727e5fe43e13fe054bc7a76603f = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x64_32x6_tn_align8;
...
void bmm_rcr_325 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 256 && N == 64 && K == 160) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f23472f4dfdada727e5fe43e13fe054bc7a76603f::ElementAccumulator;

    typename f23472f4dfdada727e5fe43e13fe054bc7a76603f::Arguments arguments{
    ...
    f23472f4dfdada727e5fe43e13fe054bc7a76603f gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rcr_325 specialization."
  );
}