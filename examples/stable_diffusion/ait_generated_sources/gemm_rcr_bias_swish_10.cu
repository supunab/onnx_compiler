...
using f14fd4840de8e5ac492354d7960e9683bfa0bea5f = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tn_align8;

void gemm_rcr_bias_swish_10 (
...
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f14fd4840de8e5ac492354d7960e9683bfa0bea5f::ElementAccumulator;

    typename f14fd4840de8e5ac492354d7960e9683bfa0bea5f::Arguments arguments{
    ...
    f14fd4840de8e5ac492354d7960e9683bfa0bea5f gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_swish_10 specialization."
  );
}