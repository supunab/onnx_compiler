...
using fbd412e3254cb5024dee17da381b8203a819ef879 = Operation_cutlass_tensorop_f16_s16816gemm_f16_64x64_64x5_tn_align8;

void gemm_rcr_bias_283 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 2 && N == 1280 && K == 1280) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fbd412e3254cb5024dee17da381b8203a819ef879::ElementAccumulator;

    typename fbd412e3254cb5024dee17da381b8203a819ef879::Arguments arguments{
    ...
    fbd412e3254cb5024dee17da381b8203a819ef879 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_283 specialization."
  );
}