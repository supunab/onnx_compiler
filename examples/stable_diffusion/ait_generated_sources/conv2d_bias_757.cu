...
using f9e28f61c144c3a728ba90f79a84b7e23297376b6 = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_256x128_32x3_nhwc_align8_base>;



void conv2d_bias_757 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 32 && WI == 32 && CI == 1920) {
    
    using ElementComputeEpilogue = typename f9e28f61c144c3a728ba90f79a84b7e23297376b6::ElementCompute;
//  TODO: cast to right dtype
    typename f9e28f61c144c3a728ba90f79a84b7e23297376b6::Arguments arguments{
        problem_size,
    ...
    f9e28f61c144c3a728ba90f79a84b7e23297376b6 implicit_gemm_op;
