...
using f6b5dfb4eb97a4ace18fdb994bfe49eca39c58d66 = Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;

void gemm_rcr_bias_fast_gelu_204 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 2048 && N == 2560 && K == 640) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f6b5dfb4eb97a4ace18fdb994bfe49eca39c58d66::ElementAccumulator;

    typename f6b5dfb4eb97a4ace18fdb994bfe49eca39c58d66::Arguments arguments{
    ...
    f6b5dfb4eb97a4ace18fdb994bfe49eca39c58d66 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_fast_gelu_204 specialization."
  );
}