...
using f21820246f2118f508fca5ebbb745e7565005f2c8 = cutlass_tensorop_f16_s16816gemm_f16_64x64_32x10_tn_align8_base;

void gemm_rcr_permute_54 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 128 && N == 320 && K == 768) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f21820246f2118f508fca5ebbb745e7565005f2c8::ElementAccumulator;

    typename f21820246f2118f508fca5ebbb745e7565005f2c8::Arguments arguments{
    ...
    f21820246f2118f508fca5ebbb745e7565005f2c8 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_permute_54 specialization."
  );
}