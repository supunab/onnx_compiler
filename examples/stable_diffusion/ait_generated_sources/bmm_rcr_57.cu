...
using f3a26a9bcd0b128f8fe987452fece00ead5be58e6 = Operation_cutlass_tensorop_f16_s16816gemm_f16_256x64_32x4_tn_align8;
...
void bmm_rcr_57 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (B == 16 && M == 4096 && N == 64 && K == 40) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f3a26a9bcd0b128f8fe987452fece00ead5be58e6::ElementAccumulator;

    typename f3a26a9bcd0b128f8fe987452fece00ead5be58e6::Arguments arguments{
    ...
    f3a26a9bcd0b128f8fe987452fece00ead5be58e6 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this bmm_rcr_57 specialization."
  );
}