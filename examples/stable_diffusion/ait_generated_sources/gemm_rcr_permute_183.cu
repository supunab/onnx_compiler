...
#define CUTLASS_CHECK(status)                                                         \
  {                                                                                   \
    ...
    cutlass::gemm::device::GemmUniversal<
        ...
        false,  /*GatherB*/
        false,  /*ScatterD*/
        cutlass::layout::Tensor5DPermute20314<1024, 1, 8> /*PermuteDLayout*/
    >;
      
using f33b4c66cfdefb9bdf2d79570a5b1e8a304d23440 = cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8_base;

void gemm_rcr_permute_183 (
 ...
 int64_t K = (*a_dim1);
  ...
  if (M == 2048 && N == 640 && K == 640) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f33b4c66cfdefb9bdf2d79570a5b1e8a304d23440::ElementAccumulator;

    typename f33b4c66cfdefb9bdf2d79570a5b1e8a304d23440::Arguments arguments{
    ...
    f33b4c66cfdefb9bdf2d79570a5b1e8a304d23440 gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_permute_183 specialization."
  );
}