...
using f061e4732e90c67bc71420eeb558f6e305f4bb1bd = cutlass::conv::device::ImplicitGemmConvolution<cutlass_tensorop_f16_s16816fprop_optimized_f16_128x128_32x3_nhwc_align8_base>;



void conv2d_bias_147 (
  ...
  *out_ch = CO;
  ...
  if (NI == 2 && HI == 32 && WI == 32 && CI == 320) {
    
    using ElementComputeEpilogue = typename f061e4732e90c67bc71420eeb558f6e305f4bb1bd::ElementCompute;
//  TODO: cast to right dtype
    typename f061e4732e90c67bc71420eeb558f6e305f4bb1bd::Arguments arguments{
        problem_size,
    ...
    f061e4732e90c67bc71420eeb558f6e305f4bb1bd implicit_gemm_op;
