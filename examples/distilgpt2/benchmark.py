    ...
    for bs in batch_sizes:
        for sl in seq_lens:
            for hs in hidden_sizes:
                ...
                out = subprocess.run(f"python3 run_gpt2.py --run_original --benchmark --batch_size {bs} --hidden_size {hs} --past_seq_len {sl} --vocab_size {vocab_size_default}", shell=True, capture_output=True)
